...
%
% Reference:
%   LIU Q., LIU P.X., WANG Y., LEUNG H.: Semi-parametric decolorization 
%   with Laplacian-based perceptual quality metric. To be published (2016)
...
%% Solver   
%wei = wei_inti(combination);  %9x1juzhen
wei = zeros(9,1);
